    ...
    "questions": [
      {
        ...
        "answers": [
          {
            "point": 0,
            "label": "Tesfai needs to buy dinner, get gas and pick up his kids on his way, home."
          },
          {
            "point": 0,
            "label": "Tesfai needs to buy dinner, get gas, and pick up, his kids, on his way home."
      ...
      
      {
        ...
        "answers": [
          {
            "point": 0,
            "label": "At recess I like, to read, play foursquare and talk, to my friends who are in other classes."
          },
          {
            "point": 10,
            "label": "At recess, I like to read, play foursquare, and talk to my friends who are in other classes."
  ...
  
      {
        ...
        "answers": [
          {
            "point": 8,
            "label": "When the class went to the zoo, they saw zebras, kangaroos, penguins, and many more animals."
          },
          {
            "point": 0,
            "label": "When the class went to the zoo, they saw zebras kangaroos penguins, and many more animals."
  ...
  
      {
        ...
        "answers": [
          {
            "point": 0,
            "label": "She likes her coffee with one packet of sugar, some skim milk and a bagel on the side."
          },
          {
            "point": 0,
            "label": "She likes her coffee with one packet of sugar some, skim, milk, and a bagel on the side."
  ...
  
      {
        ...
        "answers": [
          {
            "point": 0,
            "label": "I want to try her famous cookies, but I am allergic to eggs, milk, peanuts, and shrimp."
          },
          {
            "point": 14,
            "label": "I want to try her famous cookies, but I am allergic to eggs milk peanuts and shrimp."
